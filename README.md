...
This app shows side-by-side weather forecasts for US locations, comparing classical physics-based numerical weather prediction with modern machine-learning forecasts. Both forecasts are accessed via the [Open-Meteo API](https://open-meteo.com). The physics-based model is GFS from the National Weather Service. The machine-learning model is [ECMWF's AIFS](https://www.ecmwf.int/en/about/media-centre/news/2025/ecmwfs-ai-forecasts-become-operational). v2 ships with both so you can see where physics and ML agree and where they diverge. A future v3 will add [Google DeepMind's WeatherNext](https://developers.google.com/weathernext/).
